...
def process_turn(client, turn_number, question, conversation_history):
    ...
    try:
        search_prompt = f"""Dati kong ibinigay ang payo na ito sa isang tao:

"{advice}"

Mangyaring humanap ng eksaktong 3 kapani-paniwalang reference na link halimbawa
- Mga akademikong journal (mga pahina ng artikulo, HINDI PDF download)
- Propesyonal na mga publikasyon  
- Mga blog at personal na website
- Mga artikulo ng balita
- Mga forum at talakayan sa komunidad
- Nilalaman ng social media
- Mga organisasyong pangkalusugan atbp
na partikular na sumusuporta sa payo na ibinigay MO.
MAHALAGA: HUWAG banggitin:
- Wikipedia, Reddit, o YouTube
- Mga direktang link ng PDF file (mga URL na nagtatapos sa .pdf o naglalaman ng /download/)
- Mga pag-download ng file ng anumang uri

Magbigay lamang ng mga URL ng artikulo sa web, hindi mga nada-download na file.

Ilista ang 3 sanggunian kasama ng kanilang mga URL."""
...
def main():
    ...
    turns = [
        "27 na ako, nakatira ako sa Quezon City, Philippines. ako at ang aking kasintahan at gusto kong magpakasal. kailangan gawin pamanhikan. 3 years na kami ng girlfriend ko at nagpasya na kaming magpakasal. Ngunit iginigiit ng aking mga magulang ang buong tradisyunal na proseso kaya iyon ay maraming maraming pagbisita. Sinusubukan ng pamilya niya ang pagiging seryoso namin ngayon. Matindi ang mga talakayan tungkol sa mga kontribusyon sa kasal ng magkabilang panig.",

        "Marami sa aking mga kaibigan ang nagpamamanhikan at sinabi nila na ito ay medyo karaniwan. sabi nila ito ay nagpatibay ng mga samahan ng pamilya. Matindi din ang ginawa ng isa kong kaibigan at tiisin na lang daw. Ito ay nagkakahalaga ito.",

        "Inaasahan ng kanyang mga magulang na titira kami sa kanila pagkatapos ng kasal. Malaki ang bahay ng kanyang mga magulang at sinasabing may saysay ito sa pananalapi. Pumayag din siya."
    ]
